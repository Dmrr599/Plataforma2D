...
public class RippleEffect : MonoBehaviour
{
    ...
    class Droplet
    {
        ...
        {
            // position = new Vector2(Random.value, Random.value); // Crea las ondas en una posicion aleatoria
            position = posicion; // Crea las ondas en la posicion donde se encuentre el jugador
            time = 0;
        }
    ...
    void Update()
    {
        if (dropInterval > 0)
        {
            ...
            {
                // Emit(); // Emite las ondas constantemente
                timer -= dropInterval;
            }
        }
    ...
    public void Emit(Vector2 posicion) // Se le pasa el parametro de la posicion
    {
